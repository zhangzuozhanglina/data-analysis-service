package com.metu.analyapploginauth.handler;

import com.metu.analyapploginauth.config.JsonResult;
 ...
 * @See https://blog.csdn.net/qq_18603599/article/details/81168927
 * @See https://blog.csdn.net/qq_35098526/article/details/88949425
 * @Version 1.0
 **/
...
public class GlobalExceptionHandler {
    ...
    static {
        logExceptionFormat = "Capture Exception By GlobalExceptionHandler: Code: %s Detail: %s";
    }

    /* *
     * @Author zhengzz
     * @Description 运行时异常处理
     * @Date 23:00 2019/11/28
     * @Param [ex]
